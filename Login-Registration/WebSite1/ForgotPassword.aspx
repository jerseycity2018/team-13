    ...
    <div class="navbar navbar-default navbar-fixed-top" role="navigation">
        ...
        <div class="container">
            <div class="form-horizontal">
                ...
                <hr />
                <h4>Enter your email, instructions for password recovery will be sent here.</h4>
                <div class="form-group">
                    <asp:Label ID="lblEmail" runat="server" Text=""></asp:Label>
                    <div class="col-md-3">
                        <asp:TextBox ID="tbEmailId" CssClass="form-control" runat="server"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorEmail" CssClass="text-danger" runat="server" ErrorMessage="Enter your email" ControlToValidate="tbEmailId"></asp:RequiredFieldValidator>
                    </div>
                </div>
                <div class="form-group">
